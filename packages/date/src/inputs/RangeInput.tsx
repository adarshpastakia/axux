...
export interface RangeInputProps
  extends Omit<ControllerProps<[Date, Date]>, "value">,
    WrapperProps,
    FieldStateProps,
    RangeProps {
  /**
...
const RangeField: FC<RangeProps & WrapperProps & FieldStateProps & InnerProps> = ({
  children,
  placeholder,
  isDisabled,
  isReadonly,
  ...
  const inputLabel = useMemo(() => {
    return value
      ? `${dateFormat(value[0], format, dateLocale, isHijri)} - ${dateFormat(
          value[1],
          format,
          dateLocale,
          isHijri
...
RangeField.displayName = "AxRangeField";

export const AxRangeInput: FC<RangeInputProps> = ({
  children,
  date,
  onChange,
  onEnterPressed,
