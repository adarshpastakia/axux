...
(function e(t, n, r) {
...
})(
  {
    ...
    3: [
      function (require, module, exports) {
        ...
        var dateFormat = (function () {
          var token = /d{1,2}|e{4,6}|M{1,4}|yy(?:yy)?|([HhmsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,
            timezone =
          ...
          return function (date, mask) {
            ...
            var _ = options.utc ? "getUTC" : "get",
              ...
              flags = {
                ...
                eeee: locales[options.locale].dayNames[D + 7],
                M: M,
                MM: pad(M),
    ...
    4: [
                  ...
                  if (!arguments.length) {
                    ...
                    try {
                      var methodNameSuffix = Array.from(arguments)
                        ...
                        .join("_");
                      props = _initializer2.default["init_" + methodNameSuffix].apply(
      ...
      { "./DateConverter": 2, "./FormatDate": 3, "./initializer": 7, "./locales": 8 }
    ],
    5: [
      function (require, module, exports) {
        "use strict";
          ...
          _createClass(StringDateParser, null, [
            {
              ...
              value: function extract(string, format, formatChunk) {
                ...
                if (targetFormat.includes(formatChunk)) {
                  return parseInt(
                    string.substr(targetFormat.indexOf(formatChunk), formatChunk.length)
                  );
                }
              }
            },
          ...
          _createClass(Initializer, null, [
            ...
            },
            {
              ...
              value: function initFromStrings(dateString) {
                var format =
                  arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultFormat;
