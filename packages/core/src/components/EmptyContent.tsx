...
import { isValidElement, useMemo, type FC, type ReactElement } from "react";
import { AxIcon } from "../icons/Icon";
import { type AxTag } from "../tag/Tag";
...
export type ActionChildren = ReactElement<typeof AxTag>;

/** @internal */
export interface EmptyContentProps
  extends Pick<IconProp, "rtlFlip">,
    ElementProps,
    Partial<ChildrenProp<ActionChildren>> {
